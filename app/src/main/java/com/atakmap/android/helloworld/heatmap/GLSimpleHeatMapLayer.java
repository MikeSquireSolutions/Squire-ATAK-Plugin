...
public class GLSimpleHeatMapLayer extends GLAbstractLayer
        implements SimpleHeatMapLayer.OnLayerChangedListener {
    ...
    public GLSimpleHeatMapLayer(MapRenderer surface,
            SimpleHeatMapLayer subject) {
