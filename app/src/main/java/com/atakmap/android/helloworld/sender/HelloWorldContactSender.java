...
public class HelloWorldContactSender extends TAKContactSender {
    ...
    public String getName() {
        return _plugin.getString(R.string.squire_medevac);
    }
     ...
     */
    @Override
    public void selectRecipients(String uri,
            @NonNull URIContentRecipient.Callback callback) {
    ...
    public boolean sendContent(String uri,
            List<? extends URIContentRecipient> recipients, Callback callback) {
